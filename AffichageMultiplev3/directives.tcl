...
solution file add ./AffichageMultiple/parameters.h -type CHEADER
solution file add ./AffichageMultiple/CNN.h -type CHEADER
solution file add ./AffichageMultiple/types.h -type CHEADER
solution file add ./AffichageMultiple/convolutionReLU.h -type CHEADER
solution file add ./AffichageMultiple/centeredCrop.h -type CHEADER
solution file add ./AffichageMultiple/order.h -type CHEADER
solution file add ./AffichageMultiple/display.h -type CHEADER
solution file add ./AffichageMultiple/convolution.cpp -type C++
solution file add ./AffichageMultiple/macros_CNN.h -type CHEADER
solution file add ./AffichageMultiple/centeredCrop.cpp -type C++
solution file add ./AffichageMultiple/order.cpp -type C++
solution file add ./AffichageMultiple/display.cpp -type C++
solution file add ./AffichageMultiple/CNN.cpp -type C++

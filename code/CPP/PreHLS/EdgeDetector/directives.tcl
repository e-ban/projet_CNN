...
solution file add ./edgeDetector.h -type CHEADER
solution file add ./types.h -type CHEADER
solution file add ./convolutionSimple.h -type CHEADER
solution file add ./convolutionSimple.cpp -type C++
solution file add ./macros_CNN.h -type CHEADER
solution file add ./edgeDetector.cpp -type C++
solution file add ./kernel.h -type CHEADER

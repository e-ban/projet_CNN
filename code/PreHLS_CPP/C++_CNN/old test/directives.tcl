...
//  
//  Running on Linux xph3sei705@cimeld16 3.2.0-4-amd64 x86_64 aol
//  
...
solution options set /Flows/ModelSim/ENABLE_VOPT true
solution options set /Flows/ModelSim/ENABLE_CODE_COVERAGE true
solution options set /Flows/ModelSim/WITNESS_WAVEFORM true
...
directive set -DESIGN_HIERARCHY CNN
go analyze

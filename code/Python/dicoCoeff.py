...
#This class contains all routines to create a coefficient dictionnary
class DicoCoeff:
    ...
    #this function creates a header file in c/c++ that contains the dictionnary as 1D arrays

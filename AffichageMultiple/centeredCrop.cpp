...
void centered_crop(CNN_DATA_TYPE input[CNN_CONV1_OUT_SIZE], CNN_DATA_OUT_TYPE output[CNN_IMAGE_IN_SIZE]){
  ...
  for (int k=0; k<CNN_CONV1_OUT_RC; k++){
    int w=0;
    for (int i=k*CNN_IMAGE_IN_SIZE+CNN_CONV1_OUT_W*red_h; i<(k+1)*CNN_IMAGE_IN_SIZE-CNN_CONV1_OUT_W*red_h;i++){
